    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          local function map(keys, func, desc, mode, other_opts)
            mode = mode or 'n'
            local opts = vim.tbl_deep_extend('force', { buffer = event.buf, desc = 'LSP: ' .. desc }, other_opts or {})
      ...
      vim.list_extend(ensure_installed, {
        ...
        -- 'js-debug-adapter', -- Used to debug js/ts
      })
