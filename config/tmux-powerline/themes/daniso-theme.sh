...
ghostty_bg="#282C34"
ghostty_blue="#02AFFF"
ghostty_white="#FFFFFF"
ghostty_green="#60D701"
...
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR:-$ghostty_bg}
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-$ghostty_white}
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"tmux_session_info $ghostty_bg $ghostty_green"
		# "hostname 33 0"
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		#"earthquake 3 0"
		"pwd $ghostty_bg $ghostty_blue ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		...
		"battery $ghostty_bg $ghostty_white ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		#"air ${TMUX_POWERLINE_SEG_AIR_COLOR} 255"
		# "weather 37 255"
		#"rainbarf 0 ${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR}"
		#"xkb_layout 125 117"
		"date_day $ghostty_bg $ghostty_white ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"date $ghostty_bg $ghostty_white ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"time $ghostty_bg $ghostty_white ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
